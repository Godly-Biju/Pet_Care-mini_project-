 ...
 <!-- >>>>>>>>>>>>>>>>>>>>>>>>>>> HEADER <<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <p class="fs-4 text-white mb-lg-4">"Animals are such agreeable friends.they ask no questions they pass no critism"</p>
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                        <!--<a href="" class="btn btn-outline-light border-2 py-md-3 px-md-5 me-5">Read More</a>-->
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="pet_video.mp4" data-bs-target="#videoModal">
                            <span></span>
                        </button>
    ...
    <div class="container-fluid py-5">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>A lodging facility that's similar to daycare for kids except that you can leave your dog or cat for an overnight or extended stay.</p>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>You get a variety of dog food, cat food, or even pet toys. Another important facility that Bigbasket provides you is the pet shop online free delivery scheme.</p>
							<!--<a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>-->
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Pet grooming will involve shaving, clipping, or trimming the coat when necessary.</p>
                            <!--<a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>-->
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>We use positive reinforcement, i.e., reward-based training methods adapted to your fur baby’s comfort.</p>
                            <!--<a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>-->
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            <h5 class="text-uppercase mb-3">Pet Exercise</h5>
								<ul type="circlr">
									...
									<li>Option to include exercise.</li>
									<li>Professional walkers only.</li>
									<li>One day off / week.</li>
									<li>Special attention to ailing/ old dogs.</li>
									<li>Flexibility to choose time slot.</li>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Ask a vet online for Rs 199. Chat live with online veterinarians. Find answers for health, behavior and nutrition questions from 24x7 vet services.
							Highlights: Chat Option Available.</p>
                            <!--<a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>-->
                        </div>
                    </div>
                </div>
			...
			<br >
			<mark>&nbspFor more details contact us : 9745371542</mark>
        </div>
    </div>
    <!-- Services End -->
