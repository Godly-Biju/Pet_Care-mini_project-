...
$result = mysql_query("SELECT * FROM register WHERE email='$username'");
$row = mysql_fetch_assoc($result);
$status = $row['status'];
$pet_name = $row['pet_name'];
if($pet_name == '')
{
    echo "<Script>alert('You have to Add your Pet to Proceed! Redirecting to Pet Add Page.');</script>";
    echo "<script>location.href='20_addpet.php'</script>";
}
?>
 <!-- >>>>>>>>>>>>>>>>>>>>>>>>>>> HEADER <<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-dark mb-lg-4">Hello, </h1>
                    <h1 class="text-uppercase text-white mb-lg-4"><?php echo $name; ?></h1>
                    <h1 class="display-1 text-uppercase text-dark mb-lg-4">Make Your Pets Happy</h1>
                    <p class="fs-4 text-white mb-lg-4">"The bond with a true pet is as lasting as the ties of this Earth will ever be." - Konrad Lorenz</p>
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <h4 class="text-body mb-4">"The bond with a true pet is as lasting as the ties of this Earth will ever be." - Konrad Lorenz</h4>
