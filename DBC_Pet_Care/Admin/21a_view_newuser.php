...
<h1>New registered User's List</h1>
...
$query = "select * from register WHERE status='Review Pending'";
...
// }
      ...
      $y = $y + 1;
       ...
       echo "<td align=center><a href='CONTROLLER_ADMIN.php?adm_app_user=$unique_id'>Approve</a></td>";
