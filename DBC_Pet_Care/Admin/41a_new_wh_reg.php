...
<h1>New registered Pet care center's List</h1>
...
// }
      ...
      $y = $y + 1;
       ...
       echo "<td align=center><a href='CONTROLLER_ADMIN.php?adm_app_wh=$unique_id'>Approve</a></td>";
       echo "<td align=center><a href='CONTROLLER_ADMIN.php?adm_rej_wh=$unique_id'>Reject</a></td>";
