...
<h1 align="center">New Appointment's</h1>

<?php

$query = "select Apt_id,Pet_id,Owner,Date,Time,Reason from appointment WHERE status='New'";
...
// }
      ...
      $y = $y + 1;
       ...
       echo "<td align=center><a href='10_view.php?id=$unique_id'>View</a></td>";
