...
$query = "SELECT * FROM vaccine_breeding INNER JOIN register ON vaccine_breeding.pet_id = register.pet_id WHERE doc_approval = 'Approved' AND options = 'Vaccine' AND vaccine_breeding.status = 'New Case'";
