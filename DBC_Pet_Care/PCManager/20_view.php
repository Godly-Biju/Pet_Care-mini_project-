...
$pet_id = $_GET['id'];
$_SESSION['SESS_pet_id'] = $pet_id;
// Fetch data from the table
//$query = "SELECT * FROM appointment INNER JOIN register ON appointment.pet_id = register.pet_id WHERE apt_id = $apt_id";
// $query = "SELECT * FROM register LEFT JOIN vaccine_breeding ON
// register.pet_id = vaccine_breeding.pet_id
// WHERE vaccine_breeding.options = 'Breeding' AND (vaccine_breeding.status=0 OR vaccine_breeding.status=3)
// ";
$query = "SELECT * FROM register Where pet_id = $pet_id";
...
<table>
    ...
    <tr>
        ...
        <td>
            <button><a href="PCM_Controller.php?InformUserBreeding='<?php echo $pet_id; ?>'">Inform User</button>
        </td>
    </tr>
    <!-- <tr>
        <th>
