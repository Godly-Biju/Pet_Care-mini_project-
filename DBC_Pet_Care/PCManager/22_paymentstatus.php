...
<h1 align="center">Payment's Pending by User's</h1>

<?php

$pcuser = $_SESSION['pc_user'];

$query = "select Apt_id,Pet_id,Owner,Date,Reason,payment from appointment WHERE petcenter='$pcuser' AND payment='Billed'";
...
// }
      ...
      $y = $y + 1;
       ...
       //echo "<td align=center><a href='CONTROLLER_ADMIN.php?viewapt=$unique_id'>View</a></td>";
