...
$query = "SELECT * FROM vaccine_breeding INNER JOIN register ON vaccine_breeding.pet_id = register.pet_id WHERE vaccine_breeding.doc_approval = 'New Case' AND vaccine_breeding.options = 'Vaccine'";
            ...
            while($row=mysql_fetch_assoc($result))
{
            ...
            <tr align="center">
                ...
                <td><a href="Controller.php?vb_idva='<?php echo $row['vb_id']; ?>'">Approve</a></td>
                <td><a href="Controller.php?vb_idvr='<?php echo $row['vb_id']; ?>'">Reject</a></td>
            </tr>
        <?php //endforeach; 
    } ?>
    </table>
