...
$query = "SELECT * FROM online_consult INNER JOIN register ON online_consult.pet_id = register.pet_id WHERE online_consult.doc_id = $doc_id";
            ...
            while($row=mysql_fetch_assoc($result))
{
            ...
            <tr align="center">
                ...
                <td><a href="11_view.php?consult_id='<?php echo $row['consult_id']; ?>'">View</a></td>
            </tr>
        <?php //endforeach; 
    } ?>
    </table>
